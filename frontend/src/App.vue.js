    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.imageHistories))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.activeView === 'imageHistory'))
                        return;
                    __VLS_ctx.downloadAsset({ id: String(item.id), type: 'image', title: String(item.prompt || '历史图片'), subtitle: String(item.createdAt || ''), url: String(item.url || '') });
                } },
            ...{ class: "item-action-btn" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    for (const [item] of __VLS_getVForSourceType((__VLS_ctx.ttsHistories))) {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
            ...{ onClick: (...[$event]) => {
                    ...
                    if (!(__VLS_ctx.activeView === 'ttsHistory'))
                        return;
                    __VLS_ctx.downloadAsset({ id: String(item.id), type: 'audio', title: String(item.text || '历史语音'), subtitle: `${item.voiceId || 'voice'} · ${item.format || 'audio'} · ${item.preview ? 'preview' : 'tts'}`, url: String(item.audioUrl || '') });
                } },
            ...{ class: "item-action-btn" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
